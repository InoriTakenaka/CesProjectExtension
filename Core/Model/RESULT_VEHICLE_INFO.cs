...
namespace Model
{
     ...
     public class RESULT_VEHICLE_INFO
     {
         ...
         private string __Z_PD=string.Empty;
         private int? __IsUpload=null;
         private int? __IsAudit=null;
         private int? __IsPrint=null;
         ...
         private string __REPORT_JYXM=string.Empty;
         ...
         private string __AJ_Z_PD=string.Empty;
         private string __ZJ_Z_PD=string.Empty;
         private string __WQ_Z_PD=string.Empty;
         private string __QT_Z_PD=string.Empty;
         private string __AJ_FJXM=string.Empty;
         private string __ZJ_FJXM=string.Empty;
         private string __WQ_FJXM=string.Empty;
         private string __QT_FJXM=string.Empty;
         ...
         private string __Z_RESULT=string.Empty;
         ...
         private string __BGDBH=string.Empty;
         private string __BGDJYM=string.Empty;
         ...
         private string __QZJCDGGP=string.Empty;
         private string __OBDJYY=string.Empty;
         private string __WQYCY=string.Empty;
         private string __OBDCommCL=string.Empty;
         private string __OBDCommCX=string.Empty;
         private string __Standard=string.Empty;
         private string __VehicleKind=string.Empty;
         private string __IsEFI=string.Empty;
         private string __IsAsm=string.Empty;
         private string __OBDOutlookID=string.Empty;
         private string __OutlookID=string.Empty;
         private string __VEHICLE_DATA=string.Empty;
         private string __QDZS=string.Empty;
         private string __sunVIN=string.Empty;
         private string __PQGSL=string.Empty;
         private string __JZZL=string.Empty;
         private string __CLPFJD=string.Empty;
         private string __FDJSB=string.Empty;
         private string __QDZW=string.Empty;
         ...
         public RESULT_VEHICLE_INFO()
         {
             ...
             this.__Changed.Add("REPORT_JYXM",false);
             ...
             this.__Changed.Add("AJ_FJXM",false);
             this.__Changed.Add("ZJ_FJXM",false);
             this.__Changed.Add("WQ_FJXM",false);
             this.__Changed.Add("QT_FJXM",false);
             ...
             this.__Changed.Add("Z_RESULT",false);
             ...
             this.__Changed.Add("BGDBH",false);
             this.__Changed.Add("BGDJYM",false);
             ...
             this.__Changed.Add("QZJCDGGP",false);
             this.__Changed.Add("OBDJYY",false);
             this.__Changed.Add("WQYCY",false);
             this.__Changed.Add("OBDCommCL",false);
             this.__Changed.Add("OBDCommCX",false);
             this.__Changed.Add("Standard",false);
             this.__Changed.Add("VehicleKind",false);
             this.__Changed.Add("IsEFI",false);
             this.__Changed.Add("IsAsm",false);
             this.__Changed.Add("OBDOutlookID",false);
             this.__Changed.Add("OutlookID",false);
             this.__Changed.Add("VEHICLE_DATA",false);
             this.__Changed.Add("QDZS",false);
             this.__Changed.Add("sunVIN",false);
             this.__Changed.Add("PQGSL",false);
             this.__Changed.Add("JZZL",false);
             this.__Changed.Add("CLPFJD",false);
         ...
         public void Reset()
         {
             ...
             this.__Z_PD =string.Empty;
             this.__IsUpload =null;
             this.__IsAudit =null;
             this.__IsPrint =null;
             ...
             this.__REPORT_JYXM =string.Empty;
             ...
             this.__AJ_Z_PD =string.Empty;
             this.__ZJ_Z_PD =string.Empty;
             this.__WQ_Z_PD =string.Empty;
             this.__QT_Z_PD =string.Empty;
             this.__AJ_FJXM =string.Empty;
             this.__ZJ_FJXM =string.Empty;
             this.__WQ_FJXM =string.Empty;
             this.__QT_FJXM =string.Empty;
             ...
             this.__BGDBH =string.Empty;
             this.__BGDJYM =string.Empty;
             ...
             this.__QZJCDGGP =string.Empty;
             this.__OBDJYY =string.Empty;
             this.__WQYCY =string.Empty;
             this.__OBDCommCL =string.Empty;
             this.__OBDCommCX =string.Empty;
             this.__Standard =string.Empty;
             this.__VehicleKind =string.Empty;
             this.__IsEFI =string.Empty;
             this.__IsAsm =string.Empty;
             this.__OBDOutlookID =string.Empty;
             this.__OutlookID =string.Empty;
             this.__VEHICLE_DATA =string.Empty;
             this.__QDZS =string.Empty;
             this.__sunVIN =string.Empty;
             this.__PQGSL =string.Empty;
             this.__JZZL =string.Empty;
             this.__CLPFJD =string.Empty;
             this.__FDJSB =string.Empty;
             this.__QDZW =string.Empty;
             ...
             this.__Changed["REPORT_JYXM"] = false;
             ...
             this.__Changed["AJ_FJXM"] = false;
             this.__Changed["ZJ_FJXM"] = false;
             this.__Changed["WQ_FJXM"] = false;
             this.__Changed["QT_FJXM"] = false;
             ...
             this.__Changed["BGDBH"] = false;
             this.__Changed["BGDJYM"] = false;
             ...
             this.__Changed["QZJCDGGP"] = false;
             this.__Changed["OBDJYY"] = false;
             this.__Changed["WQYCY"] = false;
             this.__Changed["OBDCommCL"] = false;
             this.__Changed["OBDCommCX"] = false;
             this.__Changed["Standard"] = false;
             this.__Changed["VehicleKind"] = false;
             this.__Changed["IsEFI"] = false;
             this.__Changed["IsAsm"] = false;
             this.__Changed["OBDOutlookID"] = false;
             this.__Changed["OutlookID"] = false;
             this.__Changed["VEHICLE_DATA"] = false;
             this.__Changed["QDZS"] = false;
             this.__Changed["sunVIN"] = false;
             this.__Changed["PQGSL"] = false;
             this.__Changed["JZZL"] = false;
             this.__Changed["CLPFJD"] = false;
         ...
         /// <summary>
         ///设置或获取类中的[REPORT_JYXM]的数据
         /// </summary>
         public string REPORT_JYXM
         {
              set{ __REPORT_JYXM = value.Replace("'","’"); __Changed["REPORT_JYXM"] = true;}
              get{return __REPORT_JYXM;}
         }
         /// <summary>
         ///设置或获取类中的[LTGGLX]的数据
         /// </summary>
         ...
         /// <summary>
         ///设置或获取类中的[AJ_FJXM]的数据
         /// </summary>
         public string AJ_FJXM
         {
              set{ __AJ_FJXM = value.Replace("'","’"); __Changed["AJ_FJXM"] = true;}
              get{return __AJ_FJXM;}
         }
         /// <summary>
         ///设置或获取类中的[ZJ_FJXM]的数据
         /// </summary>
         public string ZJ_FJXM
         {
              set{ __ZJ_FJXM = value.Replace("'","’"); __Changed["ZJ_FJXM"] = true;}
              get{return __ZJ_FJXM;}
         }
         /// <summary>
         ///设置或获取类中的[WQ_FJXM]的数据
         /// </summary>
         public string WQ_FJXM
         {
              set{ __WQ_FJXM = value.Replace("'","’"); __Changed["WQ_FJXM"] = true;}
              get{return __WQ_FJXM;}
         }
         /// <summary>
         ///设置或获取类中的[QT_FJXM]的数据
         /// </summary>
         public string QT_FJXM
         {
              set{ __QT_FJXM = value.Replace("'","’"); __Changed["QT_FJXM"] = true;}
              get{return __QT_FJXM;}
         }
         /// <summary>
         ...
         /// <summary>
         ///设置或获取类中的[Z_RESULT]的数据
         /// </summary>
         public string Z_RESULT
         {
              set{ __Z_RESULT = value.Replace("'","’"); __Changed["Z_RESULT"] = true;}
              get{return __Z_RESULT;}
         }
         /// <summary>
         ///设置或获取类中的[HPYS]的数据
         /// </summary>
         ...
         public string BGDBH
         {
              set{ __BGDBH = value.Replace("'","’"); __Changed["BGDBH"] = true;}
              get{return __BGDBH;}
         }
         /// <summary>
         ///设置或获取类中的[BGDJYM]的数据
         ...
         {
              set{ __BGDJYM = value.Replace("'","’"); __Changed["BGDJYM"] = true;}
              get{return __BGDJYM;}
         }
         /// <summary>
         ///设置或获取类中的[SZDQLX]的数据
         ...
         /// <summary>
         ///设置或获取类中的[QZJCDGGP]的数据
         /// </summary>
         public string QZJCDGGP
         {
              set{ __QZJCDGGP = value.Replace("'","’"); __Changed["QZJCDGGP"] = true;}
              get{return __QZJCDGGP;}
         }
         /// <summary>
         ///设置或获取类中的[OBDJYY]的数据
         /// </summary>
         ...
         public string WQYCY
         {
              set{ __WQYCY = value.Replace("'","’"); __Changed["WQYCY"] = true;}
              get{return __WQYCY;}
         }
         /// <summary>
         ///设置或获取类中的[OBDCommCL]的数据
         /// </summary>
         public string OBDCommCL
         {
              set{ __OBDCommCL = value.Replace("'","’"); __Changed["OBDCommCL"] = true;}
              get{return __OBDCommCL;}
         }
         /// <summary>
         ///设置或获取类中的[OBDCommCX]的数据
         /// </summary>
         public string OBDCommCX
         {
              set{ __OBDCommCX = value.Replace("'","’"); __Changed["OBDCommCX"] = true;}
              get{return __OBDCommCX;}
         }
         /// <summary>
         ///设置或获取类中的[Standard]的数据
         /// </summary>
         public string Standard
         {
              set{ __Standard = value.Replace("'","’"); __Changed["Standard"] = true;}
              get{return __Standard;}
         }
         /// <summary>
         ///设置或获取类中的[VehicleKind]的数据
         /// </summary>
         public string VehicleKind
         {
              set{ __VehicleKind = value.Replace("'","’"); __Changed["VehicleKind"] = true;}
              get{return __VehicleKind;}
         }
         /// <summary>
         ///设置或获取类中的[IsEFI]的数据
         /// </summary>
         public string IsEFI
         {
              set{ __IsEFI = value.Replace("'","’"); __Changed["IsEFI"] = true;}
              get{return __IsEFI;}
         }
         /// <summary>
         ///设置或获取类中的[IsAsm]的数据
         ...
         public string IsAsm
         {
              set{ __IsAsm = value.Replace("'","’"); __Changed["IsAsm"] = true;}
              get{return __IsAsm;}
         }
         /// <summary>
         ///设置或获取类中的[OBDOutlookID]的数据
         /// </summary>
         public string OBDOutlookID
         {
              set{ __OBDOutlookID = value.Replace("'","’"); __Changed["OBDOutlookID"] = true;}
              get{return __OBDOutlookID;}
         }
         /// <summary>
         ///设置或获取类中的[OutlookID]的数据
         /// </summary>
         public string OutlookID
         {
              set{ __OutlookID = value.Replace("'","’"); __Changed["OutlookID"] = true;}
              get{return __OutlookID;}
         }
         /// <summary>
         ///设置或获取类中的[VEHICLE_DATA]的数据
         /// </summary>
         public string VEHICLE_DATA
         {
              set{ __VEHICLE_DATA = value.Replace("'","’"); __Changed["VEHICLE_DATA"] = true;}
              get{return __VEHICLE_DATA;}
         }
         /// <summary>
         ///设置或获取类中的[QDZS]的数据
         /// </summary>
         ...
         ///设置或获取类中的[sunVIN]的数据
         /// </summary>
         public string sunVIN
         {
              set{ __sunVIN = value.Replace("'","’"); __Changed["sunVIN"] = true;}
              get{return __sunVIN;}
         }
         /// <summary>
         ///设置或获取类中的[PQGSL]的数据
         ...
         public string JZZL
         {
              set{ __JZZL = value.Replace("'","’"); __Changed["JZZL"] = true;}
              get{return __JZZL;}
         }
         /// <summary>
         ///设置或获取类中的[CLPFJD]的数据
         /// </summary>
         public string CLPFJD
         {
              set{ __CLPFJD = value.Replace("'","’"); __Changed["CLPFJD"] = true;}
              get{return __CLPFJD;}
         }
         /// <summary>
         ///设置或获取类中的[FDJSB]的数据
