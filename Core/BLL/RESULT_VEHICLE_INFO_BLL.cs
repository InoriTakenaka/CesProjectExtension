...
{
     /// <summary>
     /// 业务逻辑层RESULT_VEHICLE_INFO
     /// </summary>
     public class RESULT_VEHICLE_INFO_BLL
     {
         public RESULT_VEHICLE_INFO_BLL()
         {
         }

         private RESULT_VEHICLE_INFO_DAL g_DAL = new RESULT_VEHICLE_INFO_DAL();
