...
{
     /// <summary>
     /// 业务逻辑层INSPECTION_DEV_REG_INFO
     /// </summary>
     public class INSPECTION_DEV_REG_INFO_BLL
     {
         public INSPECTION_DEV_REG_INFO_BLL()
         {
         }

         private INSPECTION_DEV_REG_INFO_DAL g_DAL = new INSPECTION_DEV_REG_INFO_DAL();
