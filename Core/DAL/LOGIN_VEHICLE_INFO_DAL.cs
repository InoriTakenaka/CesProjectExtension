...
{
     /// <summary>
     /// 数据访问层LOGIN_VEHICLE_INFO_DAL
     /// </summary>
     public class LOGIN_VEHICLE_INFO_DAL
     {
         private string Conn{ get;set; }
         public LOGIN_VEHICLE_INFO_DAL()
         {
         ...
         {
             int intResult = 0;
             string strSql = "select max(ID) as m from LOGIN_VEHICLE_INFO";
          ...
          public bool Exists(int intID)
          {
               ...
               string strSql = "";
               strSql += "select count(1) as c from LOGIN_VEHICLE_INFO";
               strSql += " where ";
               strSql += " ID='"+ intID +"'";
          ...
          public string InsertSQL(LOGIN_VEHICLE_INFO model)
          {
              ...
              if(model.Changed("CSYSDH") == true && model.CSYSDH != null)
              {
                   strFieldSQL += ",CSYSDH";
                   strValueSQL += ",'" + model.CSYSDH.ToString().Replace("'","''") + "'";
              }
              ...
              if(model.Changed("ZJXM") == true && model.ZJXM != null)
              {
                   strFieldSQL += ",ZJXM";
                   strValueSQL += ",'" + model.ZJXM.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("AJXM") == true && model.AJXM != null)
              {
                   strFieldSQL += ",AJXM";
                   strValueSQL += ",'" + model.AJXM.ToString().Replace("'","''") + "'";
              }
              ...
              if(model.Changed("DCZZ") == true && model.DCZZ != null)
              {
                   strFieldSQL += ",DCZZ";
                   strValueSQL += ",'" + model.DCZZ.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("SYQK") == true && model.SYQK != null)
              {
                   strFieldSQL += ",SYQK";
                   strValueSQL += ",'" + model.SYQK.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("SYQKDH") == true && model.SYQKDH != null)
              {
                   strFieldSQL += ",SYQKDH";
                   strValueSQL += ",'" + model.SYQKDH.ToString().Replace("'","''") + "'";
              }
              ...
              if(model.Changed("HXNBCD") == true && model.HXNBCD != null)
              {
                   strFieldSQL += ",HXNBCD";
                   strValueSQL += ",'" + model.HXNBCD.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("HXNBKD") == true && model.HXNBKD != null)
              {
                   strFieldSQL += ",HXNBKD";
                   strValueSQL += ",'" + model.HXNBKD.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("HXNBGD") == true && model.HXNBGD != null)
              {
                   strFieldSQL += ",HXNBGD";
                   strValueSQL += ",'" + model.HXNBGD.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("SFMJ") == true && model.SFMJ != null)
              {
                   strFieldSQL += ",SFMJ";
                   strValueSQL += ",'" + model.SFMJ.ToString().Replace("'","''") + "'";
              }
              ...
              string strSql = "";
              strSql += "insert into LOGIN_VEHICLE_INFO";
              strSql += "(";
          ...
          public string UpdateSQL(LOGIN_VEHICLE_INFO model,int intID)
          {
              ...
              if(model.Changed("CSYSDH") == true && model.CSYSDH != null)
              {
                  strUpdateSQL += ",CSYSDH='" + model.CSYSDH.ToString().Replace("'","''") + "'";
              }
              ...
              if(model.Changed("ZJXM") == true && model.ZJXM != null)
              {
                  strUpdateSQL += ",ZJXM='" + model.ZJXM.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("AJXM") == true && model.AJXM != null)
              {
                  strUpdateSQL += ",AJXM='" + model.AJXM.ToString().Replace("'","''") + "'";
              }
              ...
              if(model.Changed("DCZZ") == true && model.DCZZ != null)
              {
                  strUpdateSQL += ",DCZZ='" + model.DCZZ.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("SYQK") == true && model.SYQK != null)
              {
                  strUpdateSQL += ",SYQK='" + model.SYQK.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("SYQKDH") == true && model.SYQKDH != null)
              {
                  strUpdateSQL += ",SYQKDH='" + model.SYQKDH.ToString().Replace("'","''") + "'";
              }
              ...
              if(model.Changed("HXNBCD") == true && model.HXNBCD != null)
              {
                  strUpdateSQL += ",HXNBCD='" + model.HXNBCD.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("HXNBKD") == true && model.HXNBKD != null)
              {
                  strUpdateSQL += ",HXNBKD='" + model.HXNBKD.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("HXNBGD") == true && model.HXNBGD != null)
              {
                  strUpdateSQL += ",HXNBGD='" + model.HXNBGD.ToString().Replace("'","''") + "'";
              }

              if(model.Changed("SFMJ") == true && model.SFMJ != null)
              {
                  strUpdateSQL += ",SFMJ='" + model.SFMJ.ToString().Replace("'","''") + "'";
              }
              ...
              if(model.Changed("PQGSL") == true && model.PQGSL != null)
              {
               ...
               string strSql = "";
               strSql += "update LOGIN_VEHICLE_INFO set ";
          ...
          {
              string strSql = "";
              strSql += "delete from LOGIN_VEHICLE_INFO";
              strSql += " where ";
               strSql += " ID="+ intID +"";
         ...
         {
             string strSql = "";
             strSql += "select * from LOGIN_VEHICLE_INFO";
             strSql += " where ";
               strSql += " ID="+ intID +"";
             ...
             LOGIN_VEHICLE_INFO model = new LOGIN_VEHICLE_INFO();

             if(dtTemp.Rows.Count>0)
             {
                 model = new LOGIN_VEHICLE_INFO();
                 ...
                 model.CSYSDH = dtTemp.Rows[0]["CSYSDH"] == DBNull.Value ? "" : dtTemp.Rows[0]["CSYSDH"].ToString();
                 ...
                 model.ZJXM = dtTemp.Rows[0]["ZJXM"] == DBNull.Value ? "" : dtTemp.Rows[0]["ZJXM"].ToString();
                 model.AJXM = dtTemp.Rows[0]["AJXM"] == DBNull.Value ? "" : dtTemp.Rows[0]["AJXM"].ToString();
                 ...
                 model.DCZZ = dtTemp.Rows[0]["DCZZ"] == DBNull.Value ? "" : dtTemp.Rows[0]["DCZZ"].ToString();
                 model.SYQK = dtTemp.Rows[0]["SYQK"] == DBNull.Value ? "" : dtTemp.Rows[0]["SYQK"].ToString();
                 model.SYQKDH = dtTemp.Rows[0]["SYQKDH"] == DBNull.Value ? "" : dtTemp.Rows[0]["SYQKDH"].ToString();
                 ...
                 model.HXNBCD = dtTemp.Rows[0]["HXNBCD"] == DBNull.Value ? "" : dtTemp.Rows[0]["HXNBCD"].ToString();
                 model.HXNBKD = dtTemp.Rows[0]["HXNBKD"] == DBNull.Value ? "" : dtTemp.Rows[0]["HXNBKD"].ToString();
                 model.HXNBGD = dtTemp.Rows[0]["HXNBGD"] == DBNull.Value ? "" : dtTemp.Rows[0]["HXNBGD"].ToString();
                 model.SFMJ = dtTemp.Rows[0]["SFMJ"] == DBNull.Value ? "" : dtTemp.Rows[0]["SFMJ"].ToString();
      ...
      public LOGIN_VEHICLE_INFO[] GetModelList(string p_strWhere, string p_strOrder, int p_intPageNumber, int p_intPageSize)
      {
          ...
          LOGIN_VEHICLE_INFO[] arrModel=new LOGIN_VEHICLE_INFO[dtTemp.Rows.Count];

          for(int N=0;N<dtTemp.Rows.Count;N++)
          {
               arrModel[N] = new LOGIN_VEHICLE_INFO();
                 ...
                 arrModel[N].CSYSDH = dtTemp.Rows[N]["CSYSDH"] == DBNull.Value ? "" : dtTemp.Rows[N]["CSYSDH"].ToString();
                 ...
                 arrModel[N].ZJXM = dtTemp.Rows[N]["ZJXM"] == DBNull.Value ? "" : dtTemp.Rows[N]["ZJXM"].ToString();
                 arrModel[N].AJXM = dtTemp.Rows[N]["AJXM"] == DBNull.Value ? "" : dtTemp.Rows[N]["AJXM"].ToString();
                 ...
                 arrModel[N].DCZZ = dtTemp.Rows[N]["DCZZ"] == DBNull.Value ? "" : dtTemp.Rows[N]["DCZZ"].ToString();
                 arrModel[N].SYQK = dtTemp.Rows[N]["SYQK"] == DBNull.Value ? "" : dtTemp.Rows[N]["SYQK"].ToString();
                 arrModel[N].SYQKDH = dtTemp.Rows[N]["SYQKDH"] == DBNull.Value ? "" : dtTemp.Rows[N]["SYQKDH"].ToString();
                 ...
                 arrModel[N].HXNBCD = dtTemp.Rows[N]["HXNBCD"] == DBNull.Value ? "" : dtTemp.Rows[N]["HXNBCD"].ToString();
                 arrModel[N].HXNBKD = dtTemp.Rows[N]["HXNBKD"] == DBNull.Value ? "" : dtTemp.Rows[N]["HXNBKD"].ToString();
                 arrModel[N].HXNBGD = dtTemp.Rows[N]["HXNBGD"] == DBNull.Value ? "" : dtTemp.Rows[N]["HXNBGD"].ToString();
                 arrModel[N].SFMJ = dtTemp.Rows[N]["SFMJ"] == DBNull.Value ? "" : dtTemp.Rows[N]["SFMJ"].ToString();
